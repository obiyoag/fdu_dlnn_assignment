...
class Trainer:
    def __init__(self, exp_name):
        ...
        self.train_loader = DataLoader(train_dataset, batch_size=128, shuffle=True, num_workers=4, drop_last=True)
        ...
        self.scheduler = optim.lr_scheduler.CosineAnnealingLR(self.optimizer, T_max=(self.epochs * len(self.train_loader)))

        self.log_dir = f'./logs/{exp_name}'
